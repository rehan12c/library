...
$tanggal_pengembalian = isset($_POST['tanggal_pengembalian']) ? $_POST['tanggal_pengembalian'] : "2023-07-07";
$durasi_keterlambatan = isset($_POST['durasi_keterlambatan']) ? $_POST['durasi_keterlambatan'] : "3 Hari";
